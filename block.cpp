...
//                 {
//                     indremove.push_back(overlapindex);
//                 }
//                 //Only update newindex once; we want the earliest index that we should check
//                 else if(newindex == 0)
//                     newindex = overlapindex;
//                 
//                 //No need to move overlapchecker around, it needs to check all possible overlaps
//                 overlapchecker++;
//                 overlapindex++;
//             }
//             //if newindex is never written to, that means we deleted all potential blocks
//             //set index to the next valid index
//             if(newindex == 0)
//                 index = overlapindex;
//             else
//                 index = newindex;
//         }
//         //No extensions were done, must check next block
//         else
//             index++;
//     }
//     
//     //Delete all indexes in indremove
//     //Go backwards to avoid invalidating later indexes
//     for(auto i = indremove.rbegin(); i != indremove.rend(); i++) {
//         delete allblocks[*i];
//         allblocks[*i] = allblocks.back();
//         allblocks.pop_back();
//     }
// }
